...
const Footer = () => {
    return (
        <div className="w-full h-full mt-5 z-50">
            <div className="max-w-[1220px] px-10 mb-5 flex mx-auto md:flex-row flex-col gap-2">
            ...
            <div className="h-full bg-gray-900 w-full p-5 text-white text-[13px]">
